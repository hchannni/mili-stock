...
<img width="25%" src="https://github.com/chnh506/mili-stock/assets/81892744/711e985c-9bfb-4ec4-a1f3-65caa0e330be"/>
...
<img width="70%" src="https://github.com/chnh506/mili-stock/blob/main/images/ERD.png">
...
| --- | --- | --- | --- | --- |
| 역할 | BE | BE | FE | FE |
| 상세 | AWS EC2 서버 구축 <br/> 로그인/회원가입 <br/>회원 정보 수정 <br/>Spring Security를 활용한 권한 인가 <br/>검색 및 정렬 API <br/>파일 다중 업로드 <br/>거래 관련 메일 발송 <br/>관리자 페이지 - 상품 <br/>HTTPS/SSL <br/>HTTP 예외처리 | 상품/좋아요/카트 생성/수정/삭제 API <br/>검색 및 정렬 API <br/>AWS EC2 서버 구축 <br/>AWS S3, RDS 연결 <br/>상품/카트/좋아요 페이지 FE 로직 구현 <br/>관리자 페이지 - 상품 업로드 <br/>PPT 제작 | 마이페이지 <br/>거래프로세스(관심/예약/거래/평가) <br/>웹소켓을 이용한 채팅/알림 <br/>JSP to Thymeleaf 이전 작업 수행 | 마이페이지(프론트엔드) <br/>팀 소개 페이지(리액트) <br/>사이트 공통 디자인 <br/>협업용 Notion 페이지 제작 |
