...
|    <div align=center> `회원가입 / 로그인` </div>    |    <div align=center> `메인 화면` </div>    |
...
|    <div align=center> `검색` </div>    |    <div align=center> `관심 상품` </div>    |
...
|    <div align=center> `마이 페이지` </div>    |    <div align=center> `현장 예약` </div>    |
