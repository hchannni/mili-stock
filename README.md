...
| 상세 | 로그인/회원가입 API <br/>회원 정보 수정 API <br/>Spring Security를 활용한 권한 인가 <br/>검색 및 정렬 API <br/>HTTP 예외처리 | 상품/좋아요/카트 API <br/>검색 및 정렬 API <br/>AWS EC2 서버 구축 <br/>상품/카트/좋아요 페이지 FE 보조 <br/>HTTP 예외처리 | 피그마 디자인 <br/>메인 페이지 <br/>현장 예약 페이지 <br/>관계짜 인터뷰 및 국군복지단에 컨택 | 피그마 디자인 <br/> 로그인/회원가입 페이지 <br/>상품/카트/좋아요 페이지 <br/> 마이 페이지 <br/>협업용 Notion 페이지 제작 |
